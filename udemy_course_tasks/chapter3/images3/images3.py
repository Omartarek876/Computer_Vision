...
cropped_img = cv.resize(image, None, fx=4, fy=2)
...
img_rgb = cv.cvtColor(cropped_img, cv.COLOR_GRAY2RGB)  # Use cv.COLOR_GRAY2RGB for grayscale to RGB conversion
...
cv.imwrite("D:\\courses\\OpenCV\\mastering_opencv(udemy)\\OpenCV\\chapter4\\images3\\saved_bw3.png", img_rgb)
